(function(root,factory){
  ...
  const normalizeCatalogRows=(rows,onInvalid=()=>{})=>{
    ...
    rows.forEach(row=>{
      ...
      const value=validRow&&Object.prototype.hasOwnProperty.call(row,'listing')?row.listing:row;
      const listing=validRow?normalizeListing(value,{id:row.id,created_at:row.created_at}):null;
